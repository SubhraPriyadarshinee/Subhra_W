...
public class DivertActSecurekafkaListenerTest {
  @InjectMocks private SecureDivertAckListener secureDivertAckListener;
  @Mock private DivertAckHelper divertAckHelper;
  ...
  public void testListen() {
    Mockito.doNothing().when(divertAckHelper).doProcess(any(), any());
    secureDivertAckListener.listen(
