...
public class RdcFixitProblemServiceTest {
  ...
  @InjectMocks private RdcFixitProblemService rdcFixitProblemService;
  ...
  public void initMocks() {
    ...
    ReflectionTestUtils.setField(rdcFixitProblemService, "gson", gson);
    ReflectionTestUtils.setField(rdcFixitProblemService, "gson", gson);
  ...
  public void testReceivedQtyByPoAndPoLine() throws IOException, ReceivingException {
    ...
    Long receivedQtyByPoAndPol =
        rdcFixitProblemService.receivedQtyByPoAndPoLine(resolution, deliveryDocumentLine);
  ...
  public void testGetProblemTagInfo_containerReceivable_nonAtlasItem()
    ...
    rdcFixitProblemService.txGetProblemTagInfo(PROBLEM_TAG, headers);
