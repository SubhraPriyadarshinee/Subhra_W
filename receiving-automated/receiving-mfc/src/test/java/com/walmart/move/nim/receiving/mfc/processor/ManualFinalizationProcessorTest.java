...
public class ManualFinalizationProcessorTest {

  @InjectMocks private ManualFinalizationProcessor manualFinalizationProcessor;

  @Mock private MFCDeliveryService deliveryService;

  @Mock private NGRShipmentTransformer ngrShipmentTransformer;

  @Mock private ManualFinalizationPublisher kafkaManualFinalizationPublisher;
  ...
  public void init() {
    ...
    ReflectionTestUtils.setField(manualFinalizationProcessor, "deliveryService", deliveryService);
    ReflectionTestUtils.setField(
        manualFinalizationProcessor, "ngrShipmentTransformer", ngrShipmentTransformer);
    ReflectionTestUtils.setField(
        manualFinalizationProcessor,
        "kafkaManualFinalizationPublisher",
        kafkaManualFinalizationPublisher);
    asnDocument =
  ...
  public void resetMocks() {
    ...
    Mockito.reset(kafkaManualFinalizationPublisher);
  }
  ...
  public void testInitiateFinance() {
    ...
    doNothing().when(kafkaManualFinalizationPublisher).publish(any(NGRShipment.class));

    manualFinalizationProcessor.doExecute(receivingEvent);
