...
public class KafkaManualFinalizationPublisherTest {

  @Mock private KafkaTemplate<String, String> kafkaTemplate;

  @InjectMocks private ManualFinalizationPublisher kafkaManualFinalizationPublisher;
  ...
  public void setUp() {
    ...
    ReflectionTestUtils.setField(
        ...
        "MANUAL_FINALIZATION_TEST_TOPIC");
  ...
  public void testPublish() {
    ...
    kafkaManualFinalizationPublisher.publish(ngrShipment);
