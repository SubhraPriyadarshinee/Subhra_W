...
public class MockLabelData {
  ...
  public static ScanItem getMockScanItem() {
    return ScanItem.builder()
        .item(566051127L)
        .possibleUPC(getPossibleUPC())
        .reject(Boolean.TRUE.equals(Boolean.TRUE) ? null : ACCConstants.ACL_REJECT_ERROR_CODE)
        .exceptionLabels(getFormattedExceptionLabels())
        .labels(new ArrayList<>())
        .exceptionLabelURL("null/label-gen/deliveries/94769060/upcs/10074451115207/exceptionLabels")
        .build();
  }
  ...
  public static HawkEyeScanItem getMockHawkEyeScanItem() {
    return HawkEyeScanItem.builder()
        .item(566051127L)
        .possibleUPC(getPossibleUPC())
        .reject(Boolean.TRUE.equals(Boolean.TRUE) ? null : ACCConstants.ACL_REJECT_ERROR_CODE)
        .exceptionLabels(getHawkEyeFormattedExceptionLabels())
        .labels(new ArrayList<>())
        .exceptionLabelURL("null/label-gen/deliveries/94769060/upcs/10074451115207/exceptionLabels")
        ...
        .deptNumber(79)
        .desc1("MINNIE BNCR RCKR GRL")
        .desc2("REPLACE 550485664")
        .event(LabelingConstants.EMPTY_STRING)
        .fullUserId(LabelingConstants.FULLUSERID_SYS_ACL)
        .hazmat(LabelingConstants.EMPTY_STRING)
        .itemGroupType(ItemGroupType.DA)
        .origin("6561")
        .packType(LabelingConstants.PACKTYPE_CP)
        .possibleUPCs(getPossibleUPC().getPossibleUpcAsList())
        .size("1.0EA")
        .storeZone("B")
        .vendorNumber(389908)
        .vnpkQty(2)
