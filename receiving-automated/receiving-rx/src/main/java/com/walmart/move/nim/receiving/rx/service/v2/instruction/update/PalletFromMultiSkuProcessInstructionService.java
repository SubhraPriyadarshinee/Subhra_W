...
@Slf4j
@Service
public class PalletFromMultiSkuProcessInstructionService extends DefaultBaseUpdateInstructionService {
    ...
    public void processUpdateInstruction(UpdateInstructionRequest instructionUpdateRequestFromClient, DataHolder dataForUpdateInstruction, DeliveryDocument deliveryDocument4mDB, DeliveryDocumentLine deliveryDocumentLine4mDB, boolean setAuditQty, HttpHeaders httpHeaders) throws ReceivingException {
        ...
        updateInstructionDataValidator.validateInstructionGtinMatchesCurrentNodeApiGtin(dataForUpdateInstruction.getInstruction(),
        ...
        if (!dataForUpdateInstruction.getInstruction().getReceivingMethod().equalsIgnoreCase(HNDL_AS_CSPK_FLOOR_LOADED_CASE)) {
