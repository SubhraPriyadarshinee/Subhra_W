...
public class PartialCaseCreateInstructionServiceTest {
    @Mock
    ...
    @InjectMocks PartialCaseCreateInstructionService partialCaseCreateInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(partialCaseCreateInstructionService, "gson", gson);
    ...
    public void testServeInstruction() throws ReceivingException, IOException {
        ...
        dataHolder.setReceivingFlow("PARTIAL_CASE");
        ...
        InstructionResponse response = partialCaseCreateInstructionService.serveInstruction(request, dataHolder, MockRxHttpHeaders.getHeaders());
        Assert.assertNotNull(response);

    }

    @Test
    public void testConvertQuantitiesAndConstructResponse() throws IOException {
        Instruction instruction = MockInstruction.getInstructionV2("Build Container");
        instruction.setMove(MockInstruction.getMoveData());
        ...
        partialCaseCreateInstructionService.convertQuantitiesAndConstructResponse(instruction, line);
        Assert.assertEquals(instruction.getProjectedReceiveQtyUOM(), "PH");
        Assert.assertEquals(instruction.getProjectedReceiveQty(), 3);
