...
public class ProblemCaseCreateInstructionServiceTest {
    ...
    @InjectMocks private ProblemCaseCreateInstructionService problemCaseCreateInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(problemCaseCreateInstructionService, "gson", gson);
    ...
    @Test
    public void testServeInstruction() throws IOException, ReceivingException {
        ...
        dataHolder.setReceivingFlow("PROBLEM_CASE");
        ...
        InstructionResponse response = problemCaseCreateInstructionService.serveInstruction(request, dataHolder, MockHttpHeaders.getHeaders());
        Assert.assertNotNull(response);

    }

    @Test
    public void testValidateProjectedReceivedQuantity() {
    }
