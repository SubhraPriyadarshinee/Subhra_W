...
public class FloorLoadedCaseProcessInstructionServiceTest {
    ...
    @InjectMocks private FloorLoadedCaseProcessInstructionService floorLoadedCaseProcessInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(floorLoadedCaseProcessInstructionService, "gson", gson);
    ...
    public void testValidateUserEnteredQty() throws IOException, ReceivingException {
        ...
        InstructionResponse response = floorLoadedCaseProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
    ...
    public void testProcessUpdateInstruction_in_ea() throws ReceivingException, IOException {
        ...
        dataHolder.setReceivingFlow("FLOOR-LOADED-CASE");
        ...
        floorLoadedCaseProcessInstructionService.processUpdateInstruction(updateInstructionRequest, dataHolder, deliveryDocument, deliveryDocument.getDeliveryDocumentLines().get(0), true, MockHttpHeaders.getHeaders());
    ...
    public void testBuildContainerAndUpdateInstruction() throws ReceivingException, IOException {
        ...
        InstructionResponseImplNew instructionResponseImplNew = floorLoadedCaseProcessInstructionService.buildContainerAndUpdateInstruction(updateInstructionRequest, dataHolder, "parenttracking123", MockHttpHeaders.getHeaders());
