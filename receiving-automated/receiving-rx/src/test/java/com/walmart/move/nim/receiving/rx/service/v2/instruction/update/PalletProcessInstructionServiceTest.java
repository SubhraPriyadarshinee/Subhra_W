...
public class PalletProcessInstructionServiceTest {
    ...
    @InjectMocks private PalletProcessInstructionService palletProcessInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(palletProcessInstructionService, "gson", gson);
    ...
    public void testValidateUserEnteredQty() throws IOException, ReceivingException {
        ...
        InstructionResponse response = palletProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
        ...
        scannedData1.setKey("ZA");
        scannedData1.setValue("10");
        updateInstructionRequestUserEntered.setUserEnteredDataList(Arrays.asList(scannedData1));
        InstructionResponse response1 = palletProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
    ...
    public void testProcessUpdateInstruction_in_za() throws IOException, ReceivingException {
        ...
        palletProcessInstructionService.processUpdateInstruction(updateInstructionRequest, dataHolder, deliveryDocument, deliveryDocument.getDeliveryDocumentLines().get(0), true, MockHttpHeaders.getHeaders());
    ...
    public void testBuildContainerAndUpdateInstruction() throws ReceivingException, IOException {
        ...
        InstructionResponseImplNew instructionResponseImplNew = palletProcessInstructionService.buildContainerAndUpdateInstruction(updateInstructionRequest, dataHolder, "parenttracking123", MockHttpHeaders.getHeaders());
