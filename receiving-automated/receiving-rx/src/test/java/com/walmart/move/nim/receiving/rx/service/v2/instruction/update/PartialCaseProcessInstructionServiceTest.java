...
public class PartialCaseProcessInstructionServiceTest {

    @Mock
    private InstructionStateValidator instructionStateValidator;
    ...
    @InjectMocks private PartialCaseProcessInstructionService partialCaseProcessInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(partialCaseProcessInstructionService, "gson", gson);
    ...
    public void testValidateUserEnteredQty() throws IOException, ReceivingException {
        ...
        container.setHints(Arrays.asList("PALLET"));
        ...
        scannedData.setValue("20");

        instruction.setInstructionCreatedByPackageInfo(gson.toJson(container));
        ...
        InstructionResponse response = partialCaseProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
        ...
        scannedData1.setKey("EA");
        scannedData1.setValue("10");
        updateInstructionRequestUserEntered.setUserEnteredDataList(Arrays.asList(scannedData1));
        InstructionResponse response1 = partialCaseProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
        Assert.assertNotNull(response1);
    }

    @Test
    public void testProcessUpdateInstruction_in_ea() throws ReceivingException, IOException {
        Instruction instruction = MockInstruction.getInstructionV2("RxSerCntrCaseScan");
        instruction.setMove(MockInstruction.getMoveData());
        DeliveryDocument deliveryDocument = gson.fromJson(instruction.getDeliveryDocument(), DeliveryDocument.class);
        deliveryDocument.getDeliveryDocumentLines().get(0).getAdditionalInfo().setScannedCaseAttpQty(1000);
        ...
        dataHolder.setReceivingFlow("PARTIAL-CASE");
        ...
        partialCaseProcessInstructionService.processUpdateInstruction(updateInstructionRequest, dataHolder, deliveryDocument, deliveryDocument.getDeliveryDocumentLines().get(0), true, MockHttpHeaders.getHeaders());
    ...
    public void testBuildContainerAndUpdateInstruction() throws ReceivingException, IOException {
        ...
        InstructionResponseImplNew instructionResponseImplNew = partialCaseProcessInstructionService.buildContainerAndUpdateInstruction(updateInstructionRequest, dataHolder, "parenttracking123", MockHttpHeaders.getHeaders());
