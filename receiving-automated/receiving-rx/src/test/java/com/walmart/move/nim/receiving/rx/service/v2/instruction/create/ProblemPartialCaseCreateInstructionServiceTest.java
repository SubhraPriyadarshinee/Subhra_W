...
public class ProblemPartialCaseCreateInstructionServiceTest {
    ...
    @InjectMocks private ProblemPartialCaseCreateInstructionService problemPartialCaseCreateInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(problemPartialCaseCreateInstructionService, "gson", gson);
    ...
    public void testServeInstruction() throws ReceivingException, IOException {
        ...
        InstructionResponse response = problemPartialCaseCreateInstructionService.serveInstruction(request, dataHolder, MockHttpHeaders.getHeaders());
        Assert.assertNotNull(response);
        Assert.assertEquals(response.getDeliveryDocuments().get(0).
                getDeliveryDocumentLines().get(0).getAdditionalInfo().getAttpQtyInEaches(), 6);
    }

    @Test
    public void testConvertQuantitiesAndConstructResponse() {
    }
