...
public class PalletFromMultiSkuProcessInstructionServiceTest {
    ...
    @InjectMocks private PalletFromMultiSkuProcessInstructionService palletFromMultiSkuProcessInstructionService;
    ...
    public void initMocks() {
        ...
        ReflectionTestUtils.setField(palletFromMultiSkuProcessInstructionService, "gson", gson);
    ...
    @Test
    public void testValidateUserEnteredQty() throws ReceivingException, IOException {
        ...
        InstructionResponse response = palletFromMultiSkuProcessInstructionService.validateUserEnteredQty(updateInstructionRequestUserEntered, instruction);
        ...
        Assert.assertEquals(deliveryDocument1.getDeliveryDocumentLines().get(0).getAdditionalInfo().getAuditQty(), 20);
    }
    ...
    public void testProcessUpdateInstruction_in_ea() throws ReceivingException, IOException {
        ...
        dataHolder.setReceivingFlow("MULTI-SKU-PLT-UNPACKED-AND-RCVD");
        ...
        palletFromMultiSkuProcessInstructionService.processUpdateInstruction(updateInstructionRequest, dataHolder, deliveryDocument, deliveryDocument.getDeliveryDocumentLines().get(0), true, MockHttpHeaders.getHeaders());
        ...
        itemData.setAuditCompletedQty(10);
        deliveryDocument.getDeliveryDocumentLines().get(0).setAdditionalInfo(itemData);
        Mockito.when(updateInstructionServiceHelper.getAdditionalInfoFromDeliveryDoc(any(Instruction.class))).thenReturn(itemData);
        palletFromMultiSkuProcessInstructionService.processUpdateInstruction(updateInstructionRequest, dataHolder, deliveryDocument, deliveryDocument.getDeliveryDocumentLines().get(0), true, MockHttpHeaders.getHeaders());
    ...
    public void testBuildContainerAndUpdateInstruction() throws ReceivingException, IOException {
        ...
        InstructionResponseImplNew instructionResponseImplNew = palletFromMultiSkuProcessInstructionService.buildContainerAndUpdateInstruction(updateInstructionRequest, dataHolder, "parenttracking123", MockHttpHeaders.getHeaders());
