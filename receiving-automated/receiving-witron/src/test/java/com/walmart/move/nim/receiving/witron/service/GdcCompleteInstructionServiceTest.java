...
import static com.walmart.move.nim.receiving.core.common.ReceivingException.COMPLETE_INSTRUCTION_ALREADY_COMPLETE;
import static com.walmart.move.nim.receiving.core.common.ReceivingException.COMPLETE_INSTRUCTION_ERROR_CODE;
...
import static com.walmart.move.nim.receiving.core.common.ReceivingException.ERROR_HEADER_PALLET_CANCELLED;
import static com.walmart.move.nim.receiving.core.common.ReceivingException.ERROR_HEADER_PALLET_COMPLETED;
...
import static com.walmart.move.nim.receiving.utils.constants.ReceivingConstants.PUBLISH_CONTAINER;
...
public class GdcCompleteInstructionServiceTest extends ReceivingTestBase {
  ...
  public void initMocks() {
    ...
    ReflectionTestUtils.setField(
        witronInstructionService, "purchaseReferenceValidator", purchaseReferenceValidator);

    ReflectionTestUtils.setField(
        witronInstructionService, "instructionHelperService", instructionHelperService);
  }
  ...
  public void setReflectionTestUtil() {
    ReflectionTestUtils.setField(witronInstructionService, "gson", gson);
    ReflectionTestUtils.setField(
        witronInstructionService, "instructionPersisterService", instructionPersisterService);
  }
    ...
    try {
      InstructionResponseImplNew response =
          (InstructionResponseImplNew)
              witronInstructionService.completeInstruction(
