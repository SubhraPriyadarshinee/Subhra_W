...
@Component(ReceivingConstants.RETRYABLE_GDM_V3_DELIVERY_DOCUMENTS_SEARCH_HANDLER)
public class RetryableGdmV3DeliveryDocumentsSearchHandler
    implements DeliveryDocumentsSearchHandler {
  @Resource(name = ReceivingConstants.DELIVERY_SERVICE_RETRYABLE_V3)
