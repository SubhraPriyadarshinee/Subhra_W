...
@Component(ReceivingConstants.WITRON_LABEL_ID_PROCESSOR)
public class WitronLabelIdProcessor implements LabelIdProcessor {
  @Override
  public Integer getLabelId(String activityName, String containerType) {
    ...
    if (ReceivingConstants.SSTK_ACTIVITY_NAME.equalsIgnoreCase(activityName)) {
      labelId = LabelFormatId.WITRON_PALLET_LABEL_FORMAT.getLabelId();
    }
    return labelId;
  }
}
