...
public class OverageExceptionContainerHandlerTest extends ReceivingTestBase {
  @InjectMocks OverageExceptionContainerHandler exceptionContainerHandler;
  ...
  public void testPublishExceptionDivertToSorter() {
    ...
    verify(sorterPublisher, times(1))
        .publishException(
            eq(mockContainer.getTrackingId()), eq(SorterExceptionReason.OVERAGE), any(Date.class));
  }
}
