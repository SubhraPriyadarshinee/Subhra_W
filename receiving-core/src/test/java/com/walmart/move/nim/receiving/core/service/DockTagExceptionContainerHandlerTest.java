...
public class DockTagExceptionContainerHandlerTest extends ReceivingTestBase {
  @InjectMocks DockTagExceptionContainerHandler exceptionContainerHandler;
  ...
  public void testPublishExceptionDivertToSorter() {
    ...
    verify(sorterPublisher, times(0))
        .publishException(eq(mockContainer.getTrackingId()), any(), any());
  }
}
