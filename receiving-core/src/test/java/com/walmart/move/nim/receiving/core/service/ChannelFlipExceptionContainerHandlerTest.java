...
public class ChannelFlipExceptionContainerHandlerTest extends ReceivingTestBase {
  @InjectMocks ChannelFlipExceptionContainerHandler exceptionContainerHandler;
  ...
  public void setUp() throws Exception {
    ...
    when(tenantSpecificConfigReader.isFeatureFlagEnabled(
            eq(ReceivingConstants.ENABLE_CF_SORTER_DIVERT)))
  ...
  public void testPublishExceptionDivertToSorter() {
    ...
    verify(sorterPublisher, times(1))
        .publishException(
            eq(mockContainer.getTrackingId()), eq(SorterExceptionReason.CHFLIP), any(Date.class));
  }
}
