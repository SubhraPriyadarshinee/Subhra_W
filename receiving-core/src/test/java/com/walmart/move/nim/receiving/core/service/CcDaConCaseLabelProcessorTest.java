...
public class CcDaConCaseLabelProcessorTest extends ReceivingTestBase {
  @InjectMocks CcDaConCaseLabelDataProcessor ccDaConCaseDataProcessor;
  ...
  public void testPopulateLabelData_Success() {
    ...
    try {
      labelData = ccDaConCaseDataProcessor.populateLabelData(getTemplate(), caseContainer);
    } catch (Exception e) {
      fail();
    }
  ...
  private ContainerMetaDataForCaseLabel caseContainerMetaData() {
    ...
    miscInfo.put("poevent", "23");
    miscInfo.put("color", "23");
    miscInfo.put("isHazmat", "");
  ...
  public void testGetContainersMetaDataByTrackingIds() {
    ...
    containerMetaDataMap.putAll(
        ccDaConCaseDataProcessor.getContainersMetaDataByTrackingIds(Arrays.asList("1234556")));
